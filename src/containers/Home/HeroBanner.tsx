...
export function HeroBanner(props: HeroBannerProps) {
	...
	return (
		<div className="flex flex-col items-center justify-end h-auto min-h-96 md:h-[400px] rounded-t-lg px-8 md:px-28 pb-8 md:pb-16 mt-8 relative bg-hero bg-cover bg-no-repeat">
