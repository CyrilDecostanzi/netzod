...
export const getPostStatus = (status: number) => {
	switch (status) {
		case PostStatus.ACTIVE:
			return (
				<div className="flex items-center border border-green-500 rounded-lg px-2 sm:px-4 py-2 sm:max-w-[100px] bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
		...
		case PostStatus.AWAITING_APPROVAL:
			return (
				<div className="flex items-center border border-yellow-500 rounded-lg px-2 sm:px-4 py-2 max-w-[215px] bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
		...
		case PostStatus.INACTIVE:
			return (
				<div className="flex items-center border border-red-500 rounded-lg px-2 sm:px-4 py-2 max-w-[100px] bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
		...
		case PostStatus.DRAFT:
			return (
				<div className="flex items-center border border-blue-500 rounded-lg px-2 sm:px-4 py-2 max-w-[115px] bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
